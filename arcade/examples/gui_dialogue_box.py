...
class Window(arcade.Window):
    ...
    def add_dialogue_box(self):
        ...
        dialoguebox.text_list.append(arcade.gui.TextLabel(message, self.half_width, self.half_height, self.theme.font_color))
        self.dialogue_box_list.append(dialoguebox)

    def add_text(self):
        message = "Press this button to activate the Dialogue Box"
        self.text_list.append(arcade.gui.TextLabel(message, self.half_width-50, self.half_height))
